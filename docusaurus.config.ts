...
const config: Config = {
  ...
  themeConfig: {
    ...
    announcementBar: {
      id: 'v050',
      content: '🎉 SynapseKit v0.5.0 — Text splitters, LLM caching & retries, graph cycles & checkpointing. <a href="/synapsekit-docs/docs/roadmap">See what\'s new →</a>',
    ...
    navbar: {
      ...
      items: [
        ...
        },
        {
          type: 'html',
          position: 'left',
          value: '<span class="navbar__version">v0.5.0</span>',
        },
        {
